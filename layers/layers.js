...
var format_County_8 = new ol.format.GeoJSON();
var features_County_8 = format_County_8.readFeatures(json_County_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_County_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_County_8.addFeatures(features_County_8);
var lyr_County_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_County_8, 
                style: style_County_8,
                popuplayertitle: 'County',
                interactive: true,
                title: '<img src="styles/legend/County_8.png" /> County'
            });
var format_PAHouse_9 = new ol.format.GeoJSON();
var features_PAHouse_9 = format_PAHouse_9.readFeatures(json_PAHouse_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_PAHouse_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PAHouse_9.addFeatures(features_PAHouse_9);
var lyr_PAHouse_9 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PAHouse_9, 
                style: style_PAHouse_9,
                popuplayertitle: 'PA House',
                interactive: true,
                title: '<img src="styles/legend/PAHouse_9.png" /> PA House'
            });
var format_PASenate_10 = new ol.format.GeoJSON();
var features_PASenate_10 = format_PASenate_10.readFeatures(json_PASenate_10, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_PASenate_10 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PASenate_10.addFeatures(features_PASenate_10);
var lyr_PASenate_10 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PASenate_10, 
                style: style_PASenate_10,
                popuplayertitle: 'PA Senate',
                interactive: true,
                title: '<img src="styles/legend/PASenate_10.png" /> PA Senate'
            });
var format_USHouse_11 = new ol.format.GeoJSON();
var features_USHouse_11 = format_USHouse_11.readFeatures(json_USHouse_11, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_USHouse_11 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_USHouse_11.addFeatures(features_USHouse_11);
var lyr_USHouse_11 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_USHouse_11, 
                style: style_USHouse_11,
                popuplayertitle: 'US House',
                interactive: true,
                title: '<img src="styles/legend/USHouse_11.png" /> US House'
            });
...
lyr_BaseMap_0.setVisible(true);lyr_SchoolDistrict_1.setVisible(true);lyr_PhiladelphiaCouncilDistrict_2.setVisible(true);lyr_PhiladelphiaHighSchool_3.setVisible(true);lyr_AlleghenyCouncilDistrict_4.setVisible(true);lyr_PittsburghHighSchool_5.setVisible(true);lyr_IntermediateUnit_6.setVisible(true);lyr_Municipality_7.setVisible(true);lyr_County_8.setVisible(true);lyr_PAHouse_9.setVisible(true);lyr_PASenate_10.setVisible(true);lyr_USHouse_11.setVisible(true);
var layersList = [lyr_BaseMap_0,lyr_SchoolDistrict_1,group_Philadelphia,group_AlleghenyCounty,lyr_IntermediateUnit_6,lyr_Municipality_7,lyr_County_8,lyr_PAHouse_9,lyr_PASenate_10,lyr_USHouse_11];
...
lyr_County_8.set('fieldAliases', {'SOUND': 'SOUND', 'MSLINK': 'MSLINK', 'MAINT_CTY_': 'MAINT_CTY_', 'AREA': 'AREA', 'COUNTY_PER': 'COUNTY_PER', 'COUNTY_N_1': 'COUNTY_N_1', 'NOTE_FILE': 'NOTE_FILE', 'IMAGE_NAME': 'IMAGE_NAME', 'LEN': 'LEN', 'NUMERIC_LA': 'NUMERIC_LA', 'AREA_SQ_MI': 'AREA_SQ_MI', 'GPID': 'GPID', 'PA_CTY_COD': 'PA_CTY_COD', 'Shape_Leng': 'Shape_Leng', 'COUNTY_NAM': 'County', 'DISTRICT_O': 'DISTRICT_O', 'DISTRICT_N': 'DISTRICT_N', 'SPREAD_SHE': 'SPREAD_SHE', 'COUNTY_NUM': 'COUNTY_NUM', 'FIPS_COUNT': 'FIPS_COUNT', 'COUNTY_ARE': 'COUNTY_ARE', });
lyr_PAHouse_9.set('fieldAliases', {'MSLINK': 'MSLINK', 'H_FIRSTNAM': 'H_FIRSTNAM', 'AREA': 'AREA', 'URL': 'URL', 'H_LASTNAME': 'H_LASTNAME', 'LEN': 'LEN', 'GPID': 'GPID', 'HOME_COUNT': 'HOME_COUNT', 'Shape_Leng': 'Shape_Leng', 'PARTY': 'PARTY', 'LEG_DISTRI': 'District', 'Rep Last Name': 'Rep Last Name', 'Web page': 'Web page', });
lyr_PASenate_10.set('fieldAliases', {'MSLINK': 'MSLINK', 'AREA': 'AREA', 'URL': 'URL', 'S_LASTNAME': 'S_LASTNAME', 'LEN': 'LEN', 'GPID': 'GPID', 'S_FIRSTNAM': 'S_FIRSTNAM', 'HOME_COUNT': 'HOME_COUNT', 'Shape_Leng': 'Shape_Leng', 'PARTY': 'PARTY', 'LEG_DISTRI': 'District', 'Sen Last Name': 'Sen Last Name', 'Web page': 'Web page', });
lyr_USHouse_11.set('fieldAliases', {'MSLINK': 'MSLINK', 'AREA': 'AREA', 'URL': 'URL', 'LEN': 'LEN', 'GPID': 'GPID', 'C_FIRSTNAM': 'C_FIRSTNAM', 'HOME_COUNT': 'HOME_COUNT', 'Shape_Leng': 'Shape_Leng', 'PARTY': 'PARTY', 'C_LASTNAME': 'C_LASTNAME', 'LEG_DISTRI': 'District', 'Rep Last Name': 'Rep Last Name', 'Webpage': 'Webpage', 'Web page': 'Web page', });
...
lyr_County_8.set('fieldImages', {'SOUND': 'Hidden', 'MSLINK': 'Hidden', 'MAINT_CTY_': 'Hidden', 'AREA': 'Hidden', 'COUNTY_PER': 'Hidden', 'COUNTY_N_1': 'Hidden', 'NOTE_FILE': 'Hidden', 'IMAGE_NAME': 'Hidden', 'LEN': 'Hidden', 'NUMERIC_LA': 'Hidden', 'AREA_SQ_MI': 'Hidden', 'GPID': 'Hidden', 'PA_CTY_COD': 'Hidden', 'Shape_Leng': 'Hidden', 'COUNTY_NAM': 'TextEdit', 'DISTRICT_O': 'Hidden', 'DISTRICT_N': 'Hidden', 'SPREAD_SHE': 'Hidden', 'COUNTY_NUM': 'Hidden', 'FIPS_COUNT': 'Hidden', 'COUNTY_ARE': 'Hidden', });
lyr_PAHouse_9.set('fieldImages', {'MSLINK': 'Hidden', 'H_FIRSTNAM': 'Hidden', 'AREA': 'Hidden', 'URL': 'Hidden', 'H_LASTNAME': 'Hidden', 'LEN': 'Hidden', 'GPID': 'Hidden', 'HOME_COUNT': 'Hidden', 'Shape_Leng': 'Hidden', 'PARTY': 'Hidden', 'LEG_DISTRI': 'Range', 'Rep Last Name': 'TextEdit', 'Web page': 'TextEdit', });
lyr_PASenate_10.set('fieldImages', {'MSLINK': 'Hidden', 'AREA': 'Hidden', 'URL': 'Hidden', 'S_LASTNAME': 'Hidden', 'LEN': 'Hidden', 'GPID': 'Hidden', 'S_FIRSTNAM': 'Hidden', 'HOME_COUNT': 'Hidden', 'Shape_Leng': 'Hidden', 'PARTY': 'Hidden', 'LEG_DISTRI': 'Range', 'Sen Last Name': 'TextEdit', 'Web page': 'TextEdit', });
lyr_USHouse_11.set('fieldImages', {'MSLINK': 'Hidden', 'AREA': 'Hidden', 'URL': 'Hidden', 'LEN': 'Hidden', 'GPID': 'Hidden', 'C_FIRSTNAM': 'Hidden', 'HOME_COUNT': 'Hidden', 'Shape_Leng': 'Hidden', 'PARTY': 'Hidden', 'C_LASTNAME': 'Hidden', 'LEG_DISTRI': 'Range', 'Rep Last Name': 'TextEdit', 'Webpage': 'TextEdit', 'Web page': 'TextEdit', });
...
lyr_PittsburghHighSchool_5.set('fieldLabels', {'SchoolName': 'no label', });
lyr_IntermediateUnit_6.set('fieldLabels', {'IU_NAME': 'no label', });
lyr_Municipality_7.set('fieldLabels', {'MUNICIPAL1': 'no label', });
lyr_County_8.set('fieldLabels', {'COUNTY_NAM': 'no label', });
lyr_PAHouse_9.set('fieldLabels', {'LEG_DISTRI': 'inline label - visible with data', 'Rep Last Name': 'no label', 'Web page': 'no label', });
lyr_PASenate_10.set('fieldLabels', {'LEG_DISTRI': 'inline label - visible with data', 'Sen Last Name': 'no label', 'Web page': 'no label', });
lyr_USHouse_11.set('fieldLabels', {'LEG_DISTRI': 'inline label - visible with data', 'Rep Last Name': 'no label', 'Webpage': 'hidden field', 'Web page': 'no label', });
lyr_USHouse_11.on('precompose', function(evt) {
