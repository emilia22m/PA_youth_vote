...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-9068937.539567, 4741655.844766, -8174381.289567, 5301873.937201], maxZoom: 15, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-9068937.539567, 4741655.844766, -8174381.289567, 5301873.937201], map.getSize());
        ...
        if (currentFeature !== highlight) {
            ...
            if (currentFeature) {
                ...
                if (currentFeature.getGeometry().getType() == 'Point' || currentFeature.getGeometry().getType() == 'MultiPoint') {
                    ...
                    highlightStyle = new ol.style.Style({
                        fill: new ol.style.Fill({
                            color: 'rgba(255,255,0,0.1)'// '#ffff00'
                        })
                    })
                }
